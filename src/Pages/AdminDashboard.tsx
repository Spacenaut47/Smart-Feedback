        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-slate-600 text-lg">Manage and track all feedback submissions</p>
            </div>
            <button
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {paginatedFeedbacks.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-sm text-slate-600 font-medium">
                      <span className="text-slate-800 font-semibold">{fb.category}</span> / {fb.subcategory}
                    </p>
                  </div>
                  ...
                  {fb.imageUrl && !expandedCards.has(fb.id) && (
                    <div className="mb-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                      <div className="flex items-center gap-2 text-blue-700">
                        ...
                        <span className="text-sm font-medium">Click to view attached image</span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="bg-slate-50 rounded-xl p-3 mb-3">
                    <div className="text-sm text-slate-600 mb-1">
                      ...
                      <span className="font-semibold text-slate-800">{fb.fullName}</span>
                    </div>
              ...
              <div className="col-span-full text-center py-16">
                ...
                <p className="text-slate-500 text-lg font-medium">No feedbacks found</p>
                <p className="text-slate-400 text-sm mt-2">Try adjusting your filters to see more results</p>
              </div>
            )}
          </div>
